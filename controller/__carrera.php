...
if ($action == 'combobox') {
    ...
    foreach ($combo as $key => $val) {
        $cbx[$key] = array("idCarrera" => $val->idCarrera, "carDescripcion" => $val->carDescripcion, "carPeriodos" => $val->carPeriodos, "idCosto" => $val->idCosto);
    }
...
if ($action == 'find') {
    ...
    $jsonCarrera = array("idCarrera" => $carrera->idCarrera, "descripcion" => $carrera->carDescripcion, "periodos" => $carrera->carPeriodos, "idCosto" => $carrera->idCosto);
